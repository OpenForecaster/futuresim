...
# GRPO (Group Relative Policy Optimization) for Chemistry MCQ — NO KL divergence.
# Standard RL with environment reward only, no reference model constraint.
# Comparison baseline against OPSD on the same model/dataset.
#
# Model: Qwen3-4B-Instruct-2507
# bash examples/train/algorithms/grpo/run_grpo_chemistry_qwen3_4b_nokl.sh
...
# GRPO settings — no KL, no ref model
...
RUN_NAME="grpo_Qwen3-4B-Instruct-2507_nokl_bs${TRAIN_BATCH_SIZE}_lr${LR}"
