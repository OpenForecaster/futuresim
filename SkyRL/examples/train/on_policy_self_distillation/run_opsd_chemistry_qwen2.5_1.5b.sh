...
# On-Policy Self-Distillation (OPSD) for Chemistry MCQ (SciKnowEval).
...
# bash examples/train/on_policy_self_distillation/run_opsd_chemistry_qwen2.5_1.5b.sh
...
# Overlong filtering DISABLED: KL reward provides the learning signal regardless of EOS.
...
PROJECT_NAME="chemistry_opsd"
RUN_NAME="opsd_${MODEL##*/}_self_distill_bs${TRAIN_BATCH_SIZE}_lr${LR}"
