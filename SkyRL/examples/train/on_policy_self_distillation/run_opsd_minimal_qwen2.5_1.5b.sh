...
# Minimal OPSD experiment: Qwen2.5-1.5B base self-distillation
# Same model as both student and teacher. Teacher gets privileged info (ground truth).
...
PROJECT_NAME="aime_opsd_minimal"
