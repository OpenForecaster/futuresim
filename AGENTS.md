...
- Always try the simplest viable approach to any problem or task first, and only try something more complex if you think its likely a simpler approach won't work.
...
## Collaborators, cluster, path management
